      ...
      <div>
            <Col span="24" v-if="car != null && car != ''">
                  <Card>
                        ...
                        <div class="ZDmessAll">
                              <Row class-name='RowSty'>
                                    <Col span="12" style="text-align: center">
                                          <div>
                                                <Tag color="cyan">{{ZdMess.hyl}}</Tag>L
                                          </div>
                                          <span class="label">累计油量</span>
                                    </Col>
                                    <Col span="12" style="text-align: center">
                                          <div>
                                                <Tag color="cyan">{{getFix(ZdMess.sjyh)}}</Tag>L/H
                                          </div>
                                          <span class="label">瞬时油耗</span>
                                    </Col>

                                    <Col span="12" style="text-align: center">
                                          <div>
                                                <Tag color="cyan">{{ZdMess.coolantTemperature}}</Tag>℃
                                          </div>
                                          <span class="label">冷却液温度</span>
                                    </Col>
                                    <Col span="12" style="text-align: center">
                                          <div>
                                                <Tag color="cyan">{{ZdMess.intakeTemperature}}</Tag>℃
                                          </div>
                                          <span class="label">进气温度</span>
                                    </Col>

                                    <Col span="12" style="text-align: center">
                                          <div>
                                                <Tag color="cyan">{{ZdMess.loadValue}}</Tag>%
                                          </div>
                                          <span class="label">发动机负荷</span>
                                    </Col>
                                    <Col span="12" style="text-align: center">
                                          <div>
                                                <Tag color="cyan">{{ZdMess.jqmxdwz}}</Tag>%
                                          </div>
                                          <span class="label">节气门位置</span>
                                    </Col>
                                    <Col span="24">
            		...
            		font-weight: 600;padding: 6px 0">
                                                ...
                                                累计里程：
                                                <Tag color="cyan">{{ZdMess.mileage}}</Tag>
                                                公里
                                          </div>
                                    </Col>
                                    ...
                                    <Col span="12" style="text-align: center">
                                          <div>
                                                <Tag color="cyan">{{ZdMess.gpsTempo}}</Tag>km/h
                                          </div>
                                          <span class="label">时速</span>
                                    </Col>
                                    <Col span="12" style="text-align: center">
                                          <div>
                                                <Tag color="cyan">{{ZdMess.controlVoltage}}</Tag>v
                                          </div>
                                    ...
                                    <Col span="12" style="text-align: center">
                                          <div>
                                                <Tag color="cyan">{{ZdMess.engineSpeed}}</Tag>rpm
                                          </div>
                                          <span class="label">转速</span>
                                    </Col>
                                    <Col span="12" style="text-align: center">
                                          <div>
                                                <Tag color="cyan">0</Tag>℃
                                          </div>
                                    ...
                                    <Col span="12" style="text-align: center">
                                          <Button shape="circle" type="error" @click="compName='zl'" icon="ios-construct"></Button><br>
                                          <span class="label">车辆自检</span>
                                    </Col>
                              </Row>
                        </div>
                  </Card>
            </Col>
            <component :is="compName" :zdbh="car!=null?car.zdbh:''"></component>
      </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getZdMess(zdbh){
                this.$http.post('/api/zdgl/getObdInfo',{ zdbh:zdbh}).then(res=>{
