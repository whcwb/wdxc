...
<template>
      <div class="box-row">
            <div style="position:absolute;width:430px;padding-top:30px;padding-left:30px;z-index:9999">
                  <Col span="24">
                        <Input placeholder="查设备、找车辆、找司机、123" size="large" v-model="searchKey">
            ...
            <div style="position:absolute;width:300px;top:0;right:0;z-index:9990;padding-top:30px;padding-right:30px;float: right"
    ...
    export default {
        ...
        methods: {
            startQuery() {
                ...
                let v = this;
                setTimeout(() => {
                    if (v.$route.path != '/OperationMonitoring/VehicleMonitoring') {
                        return;
                    }
                    v.queryGps()
                    v.startQuery();
            ...
            initGps() {
                var v = this
                this.$http.get(this.apis.CLJK.QUERY, {params: {zdLx: '10'}}).then((res) => {
                    if (res.code === 200) {
