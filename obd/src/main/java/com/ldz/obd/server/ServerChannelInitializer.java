...
import com.ldz.obd.common.adapter.MessageDecoder;
import com.ldz.obd.common.adapter.MessageEncoder;
...
public class ServerChannelInitializer extends ChannelInitializer<SocketChannel> {
	...
	protected void initChannel(SocketChannel socketChannel) throws Exception {
		...
		ByteBuf charsetBuf = Unpooled.copiedBuffer(ByteBufUtil.decodeHexDump(MessageBean.tail));

		//解包转换类
		pipeline.addLast("decoder", new MessageDecoder(MAX_FRAME_LENGTH, charsetBuf));
		//封包转换类
