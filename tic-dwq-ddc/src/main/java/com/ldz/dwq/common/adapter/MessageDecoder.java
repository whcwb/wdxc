...
public class MessageDecoder extends LengthFieldBasedFrameDecoder {
    ...
    protected Object decode(ChannelHandlerContext ctx, ByteBuf in) throws Exception {
        ...
        msg.setMid(dataArray[0]);
        msg.setImei(dataArray[1]);
        msg.setLen(dataArray[2]);
        msg.setCommand(dataArray[3].split(",")[0]);
        msg.setData(dataArray[3].substring(msg.getCommand().length() + 1));
